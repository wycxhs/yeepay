package com.yeepay.dao.individual;
...
public class IndividualPost {
    ...
    @NotEmpty(message = "merLegalPhone不能为空")
    @Size(max = 128,message = "merLegalPhone数据异常")
    private String merLegalPhone;
    @Size(max = 128,message = "merLegalEmail数据异常")
    ...
    @NotEmpty(message = "merScope不能为空")
    @Size(max = 1024,message = "merScope数据异常")
